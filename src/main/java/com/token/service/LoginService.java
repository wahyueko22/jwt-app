...
public class LoginService {
	...
	public LoginService (UserRepository userRepository, RoleRepository roleRepository, UserRoleMappingRepository userRoleMappingRepository,
			RefreshTokenRepository loginRepository, TokenProviderUtil tokenProviderUtil) {
	...
	public LoginResponse extractToken(String token) throws Exception {
		Claims claims = tokenProviderUtil.getAuthentication(token);
		logger.info("claims = {}", claims);
		LoginResponse logResponse = new LoginResponse(null, null, claims.getId() , claims.getSubject(), claims.get("role"));
		return logResponse;
	}
